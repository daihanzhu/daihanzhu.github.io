  ...
  sectionAContent() {
    return (<div className="daihan-caption">
      ...
      <p className="daihan-desc">
        Growing up, I loved art, books, and computers. I would spend hours and hours making art on computers and coming up with stories and characters.
        <br/><br/>
        ...
        <br/><br/>
        Since then, I’ve worked with startups, enterprises, agencies, banks, and studios while working on a multitude of personal projects.
        <br/><br/>
      ...
      <p className="daihan-desc">
        ...
        <br/><br/>
        My advice is to design and re-design as many solutions to problems you’ve encountered in the real world as possible. Get feedback, and repeat. That'll get you to problem-solve right away and learn from each iteration. Use an exsiting Design Systems such Material UI to get started.
        <br/><br/>
        I’d love to chat about career advice and porfolio building. Feel free to reach out.
      </p>
