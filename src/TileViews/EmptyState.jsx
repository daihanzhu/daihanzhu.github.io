      ...
      <div className="empty-state">
        ...
        <div className="content-wrapper">
          ...
          <div className="side-caption">
            <h2 className="original-state-caption">Why is it important</h2>
        ...
        <div className="content-wrapper mid-content-wrapper ">
          ...
          <div className="par-block">
            <h2>Almost there</h2>
            <p>So like, it’s often a challenge to know when the work is complete. As an illustrator working on personal projects, I see it as a way to improve so I’m not overly attached to almost-finished-probably-uninspired designs. So feedback is important. I’ve worked with clients in the past where my definition of halfway there is nearly perfect. So the image above is what I send out to the rest of the team in addition to the few I’ve been getting consistent feedback from. The goal here is to narrow down to one concept for each screen.</p>
